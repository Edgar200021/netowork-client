...
import {workActions, workSelectors, workSlice} from '@/store/portfolio/workSlice';
...
export const AddWorkImages = () => {
  ...
  return (
    <div className="px-[10px] flex flex-col gap-y-1">
      ...
      >
        <p className="max-w-[220px] hidden sm:block text-center">Перетащите файл в эту область, чтобы загрузить</p>
        ...
        <Button
          className={cn('bg-white text-primary-foreground shadow-none sm:font-semibold sm:text-lg', {
